...
class FamiliasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'familia_nome' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'familia_nome' => 'Lorem ipsum dolor sit amet',
                'status' => 1,
                'created' => '2020-06-21 20:31:13',
                'modified' => '2020-06-21 20:31:13',
            ],
        ];
        parent::init();
    }
